...
### Fachhochschule Köln (Campus Gummersbach) - Diploma in Business Informatics (no degree)
##### 2003-12-31 - 2005-12-31


### Berufskolleg Oberberg Ernährung-Sozialwesen-Technik Gummersbach - State-certified IT Assistant, University of Applied Sciences entrance qualification in Information Technology
...
* Advanced in Leadership (Team leadership, People management, Team management, Mentoring, Team motivation)
* Advanced in Software Architecture (Service-oriented, Microservices, Data modeling, Process modeling, Migration strategies, DDD)
* Advanced in Software Design (OOP, Separation of concerns, Clean Code, S.O.L.I.D., Design patterns)
* Expert in PHP (PHP 3.0 - 8.5, composer, PDO, Propel, FPDF/FPDI)
* Expert in Symfony (Bundles, DI Container, API Platform, Event Dispatcher, Twig, Flex)
* Advanced in DevOps (CI/CD, GitLab CI, Docker/Docker Compose, Ansible, Bash, GNU Make, TeamCity, Hudson/Jenkins, Travis CI, Harbor, Renovate)
* Advanced in Cloud (Kubernetes, Helm, Rancher, AWS, Google Cloud, Digital Ocean, Heroku, Dokku, K3s)
* Advanced in IT Security (ISO 27001, ISMS, Vulnerability Management, Incident Response)
* Advanced in Quality Assurance (Automated tests, PHPUnit, Continuous integration, Test-driven design, Static code analysis)
* Advanced in APIs &amp; Web Services (REST, GraphQL, OpenAPI/Swagger, SOAP, JSON-RPC)
* Advanced in Relational Databases (MySQL, MariaDB, PostgreSQL)
* Intermediate in NoSQL (MongoDB, Redis)
* Advanced in Messaging (RabbitMQ, MQTT (Mosquitto))
* Intermediate in Monitoring &amp; Observability (Grafana, Sentry, InfluxDB, ELK, Graylog)
* Advanced in Git (GitHub, GitLab, Bitbucket)
* Advanced in Web Servers (Caddy, Apache, Nginx, Lighttpd)
* Advanced in IDEs &amp; Debugging (Visual Studio Code, PHPStorm, Eclipse, XDebug, Gitpod)
* Advanced in Agile Methods (Scrum, Kanban)
* Advanced in Analysis (Object-oriented analysis, Requirements analysis, Reverse Engineering)
* Advanced in Collaboration &amp; Project Management (Jira, Slack, Wiki, Confluence, Asana, monday.com, miro)
* Advanced in Operating Systems (Linux (Ubuntu), DOS, Windows 95 to 7)
* Intermediate in Virtualization (LXC, Virtualbox, VMWare)
* Intermediate in Other Programming Languages (Java, C#, C / C++, HTML / CSS, Python, poetry, async)
* Intermediate in Other Version Control Systems (Mercurial, Subversion, CVS)
* Advanced in Doctrine (ORM, ODM)
